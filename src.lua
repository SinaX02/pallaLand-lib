...
local Mouse = LocalPlayer:GetMouse()                      -- By SinaXFR
...
local Library = {
	Themes = {
		...
		Vaporwave = {
			Main = Color3.fromRGB(37, 35, 33),
			Secondary = Color3.fromRGB(65, 63, 63),
			Tertiary = Color3.fromRGB(101, 237, 38),
		...
		OperaGX = {
			Main = Color3.fromRGB(37, 35, 33),
			Secondary = Color3.fromRGB(63, 64, 65),
			Tertiary = Color3.fromRGB(81, 38, 237),
		...
		VisualStudio = {
			Main = Color3.fromRGB(37, 35, 33),
			Secondary = Color3.fromRGB(65, 63, 63),
			Tertiary = Color3.fromRGB(237, 38, 171),
...
function Library:create(options)
	...
	if readfile and writefile and isfile then
		if not isfile("pallaLandSettings.json") then
			writefile("pallaLandSettings.json", HTTPService:JSONEncode(settings))
		end
		settings = HTTPService:JSONDecode(readfile("pallaLandSettings.json"))
	...
	if getgenv and getgenv().pallaLandUI then
		getgenv():pallaLandUI()
		getgenv().pallaLandUI = nil
	end
	...
	local creditsTab = Library.tab(mt, {
		...
		Icon = "http://www.roblox.com/asset/?id=11919779160"
	})
...
function Library:toggle(options)
	...
	local on = "http://www.roblox.com/asset/?id=11919779160"
	local off = "http://www.roblox.com/asset/?id=11919779160"
